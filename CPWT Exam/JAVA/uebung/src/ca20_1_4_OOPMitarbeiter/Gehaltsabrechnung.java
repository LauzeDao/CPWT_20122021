 package ca20_1_4_OOPMitarbeiter;
 ...
 public class Gehaltsabrechnung {
		...
		public static void main(String[] args) {
			...
			Gehaltsabrechnung.mitarbeiter =
					new Mitarbeiter[Gehaltsabrechnung.MITARBEITER_ANZAHL];
			...
			((Arbeiter) Gehaltsabrechnung.mitarbeiter[0]).stundenzahl = 8;
			((Arbeiter) Gehaltsabrechnung.mitarbeiter[0]).schichtzulage = 10;
			
			for (int i = 0; i < Gehaltsabrechnung.mitarbeiter.length; i++) {
				
				Gehaltsabrechnung.bruttosumme += 
						Gehaltsabrechnung.mitarbeiter[i].berechneMonatsBrutto();
			}
			System.out.println("Bruttosumme: " + Gehaltsabrechnung.bruttosumme);
		}
	}
	...
	class Arbeiter extends Mitarbeiter {
		...
		double berechneMonatsBrutto() {
			...
			return this.stundenlohn * this.stundenzahl * this.schichtzulage;
		}
	}
	...
	class Manager extends Mitarbeiter {
		...
		double berechneMonatsBrutto() {
			...
			return this.fixgehalt * this.provision * this.umsatz;
		}
	}